...
double x[4];
double u =0;
double k_lqr[4]={231.6228, 3035.6676, -487.4252, -160.8704}; //600.278, 1400.8966, -1300, -40    ////800.0, 2821.26, -751.94, -203.659
double PWM=0;
double v_motor = A0;
double ang_old=0;
...
/////////////////////////    CODIGO DE CONTROL      //////////////////////////
   ...
   ////////////////////// LECTURA DE DATOS  ////////////////////
   Input_mpu = kalAngleY;  // compAngleY    ANGULO
   Input_mpu_k=kalAngleY;
   ...
   x[1]=(x[0]-pos_old)/0.046;//(analogRead(v_motor)*0.0033)/1023;   //Velocidad lineal m/s
   x[2]=(Input_mpu*(3.1416/180))-(Setpoint*(3.1416/180)); 
   ang_k=(Input_mpu_k*(3.1416/180))-(Setpoint*(3.1416/180));;//Angulo rad
   x[3]=(ang_k-ang_old_k)/0.046;                                       //Velocidad angular rad/s                                            
...
/////////////////////////////////////////////////////////////////////////////////////
  ...
  Serial.print("vel_ang:");
  Serial.print(x[3]); Serial.print("\t");
  Serial.print("cel_lin:");
